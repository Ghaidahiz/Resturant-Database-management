...
public class App {
    ...
    public static void main(String[] args) throws Exception {
        ...
        { // ************ MANAGER REMOVE VEIW *************
            ...
            comboBox.setModel(
                    new DefaultComboBoxModel(new String[] { " Employee_ID", "Emp_Name", "Gender", "Role", "Salary" }));
        ...
        { // ************ MANAGER UPDATE VEIW *************
            ...
            btnNewButton.addActionListener(new ActionListener() {
                public void actionPerformed(ActionEvent E) {
                    try {
                        ...
                        if (numOfAffectedRow == 0)
                            JOptionPane.showMessageDialog(null, "There is no Empolyee with the received ID");
            ...
            comboBox_2.setModel(new DefaultComboBoxModel<String>(new String[] { "00", "01", "02", "03", "04", "05",
